...
//for making issues
var repoIssues = "Enter the name of the repo you want to create issues for.";
var issueName = "Enter the name of the issues."
if( !config.token )
{
...
if (process.env.NODE_ENV != 'test')
{
	(async () => {
		...
		await listBranches(userId, "Triangle");
		await createRepo(userId,"HW4-345");
		await createIssue(userId, "modSim", "first issue", "this is practice");
